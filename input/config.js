const fs = require("fs");
const width = 3000;           // burada resim oranını giriyoruz
const height = 3000;
const dir = __dirname;
const description = "This is an NFT made by the coolest generative code.";
const baseImageUri = "https://hashlips/nft";
const startEditionFrom = 1;
const endEditionAt = 20;      // burada kodun kaç tane olması gerektiğini giriyoruz
const editionSize = 20;       // buraya da aynısı
const raceWeights = [
  {
    value: "skull",
    from: 1,
    ...
    layers: [
      {
        ...
        elements: [
          {
            id: 0,                                        //yeni id ekleyerek yeni arkaplan ekleyebilirim
            name: "Light blue",                           //buradan adını değiştirmeyi unutma
            path: `${dir}/1-background/LightBlue.png`,    //buradan dosyanın adını girmeyi unutmadan tabi ki
            weight: 100,                                  //burada nadirlik oranını hesaplıyoruz 100 üzerinden
          },
          {
            id: 1,
            name: "Orange",
